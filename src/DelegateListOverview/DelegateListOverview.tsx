...
const DelegateListOverview = (props : any) => {
    ...
    const [minAvailableForInMonth, setMinAvailableForInMonth] = React.useState<number | undefined>(undefined);
    ...
    const [requestDelegateOffersOptions, setRequestDelegateOffersOptions] = React.useState<RequestDelegateOffersOptions>({
        MaxAvailableForInMonth: undefined,
        MaxPrice: undefined,
        MinAvailableForInMonth: undefined,
        MinPrice: undefined,
        PageNumber: 1,
        PageSize: 9,
        RegionQuery: "",
    ...
    function handleLoadDelegates() {
        setDelegateCards(<div><Spinner animation="border" variant="primary"/></div>);
    ...
    const loadDelegates = async (reqOptions: RequestDelegateOffersOptions) => {
        ...
        if (reqOptions.MaxAvailableForInMonth) url += `&MaxAvailableForInMonth=${reqOptions.MaxAvailableForInMonth}`
        if (reqOptions.MinAvailableForInMonth) url += `&MinAvailableForInMonth=${reqOptions.MinAvailableForInMonth}`
    ...
    const applyFiltering = () => {
        ...
        alteredRequestOptions.MinAvailableForInMonth = minAvailableForInMonth
        alteredRequestOptions.MaxAvailableForInMonth = maxAvailableForInMonth
    ...
    const clearFilteringFields = () => {
        ...
        setMinPrice("")
        // @ts-ignore
        setMaxAvailableForInMonth("")
        // @ts-ignore
        setMinAvailableForInMonth("")
    }
    ...
    const onMinAvailabilityChange = (event: any) => {
        setMinAvailableForInMonth(event.target.value)
    ...
    const onMaxAvailabilityChange = (event: any) => {
        setMaxAvailableForInMonth(event.target.value)
